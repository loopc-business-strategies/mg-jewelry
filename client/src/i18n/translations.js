  ...
  en: {
    ...
    ourMg: {
      ...
      connect: {
        ...
        buyTitle: 'BUY GOLD',
        buyDesc: 'Choose gold, book when ready, collect at a center.',
        buySteps: ['Select', 'Book', 'Collect'],
        buyCta: 'EXPLORE GOLD',
        sellTitle: 'SELL GOLD',
        sellDesc: 'Check the price, bring your gold, complete at a center.',
  ...
  ru: {
    ...
    ourMg: {
      ...
      connect: {
        ...
        buyDesc: 'Выберите золото, забронируйте, когда готовы, заберите в центре.',
        buySteps: ['Выбрать', 'Забронировать', 'Забрать'],
        buyCta: 'ИЗУЧИТЬ ЗОЛОТО',
        sellTitle: 'ПРОДАТЬ ЗОЛОТО',
        sellDesc: 'Проверьте цену, принесите золото, завершите в центре.',
  ...
  uz: {
    ...
    ourMg: {
      ...
      connect: {
        ...
        buyDesc: 'Oltinni tanlang, tayyor bo\'lganda band qiling, markazda oling.',
        buySteps: ['Tanlash', 'Band qilish', 'Olish'],
        buyCta: 'OLTINNI O\'RGANING',
        sellTitle: 'OLTIN SOTISH',
        sellDesc: 'Narxni tekshiring, oltinni olib keling, markazda yakunlang.',
  ...
  ar: {
    ...
    ourMg: {
      ...
      connect: {
        ...
        buyTitle: 'شراء الذهب',
        buyDesc: 'اختر الذهب، واحجز عندما تكون مستعداً، واستلمه من المركز.',
        buySteps: ['اختر', 'احجز', 'استلم'],
        buyCta: 'استكشف الذهب',
        sellTitle: 'بيع الذهب',
        sellDesc: 'تحقق من السعر، وأحضر ذهبك، وأكمل في المركز.',
  ...
  tr: {
    ...
    ourMg: {
      ...
      connect: {
        ...
        buyTitle: 'ALTIN AL',
        buyDesc: 'Altını seçin, hazır olduğunuzda rezerve edin, merkezden teslim alın.',
        buySteps: ['Seç', 'Rezerve Et', 'Teslim Al'],
        buyCta: 'ALTINI KEŞFET',
        sellTitle: 'ALTIN SAT',
        sellDesc: 'Fiyatı kontrol edin, altınınızı getirin, merkezde tamamlayın.',
