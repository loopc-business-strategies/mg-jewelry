...
export const footerColumns = {
  shop: [
    { label: 'Home', path: '/', key: 'footer.links.home' },
    { label: 'All Collections', path: '/shop', key: 'footer.links.allCollections' },
    { label: 'Chains', path: '/shop/chains', key: 'footer.links.chains' },
    { label: 'Bangles', path: '/shop/bangles', key: 'footer.links.bangles' },
    { label: 'New Arrivals', path: '/shop?sort=newest', key: 'footer.links.newArrivals' },
    { label: 'Best Sellers', path: '/shop?sort=best_selling', key: 'footer.links.bestSellers' },
  ],
  about: [
    { label: 'About', path: '/about', key: 'footer.links.about' },
    { label: 'Our MG', path: '/our-mg', key: 'footer.links.ourMg' },
    { label: 'Collections', path: '/shop', key: 'footer.links.collections' },
    { label: 'Custom Jewelry', path: '/custom-jewelry', key: 'footer.links.customJewelry' },
    { label: 'Contact', path: '/contact', key: 'footer.links.contact' },
    { label: 'Sell Gold', path: '/gold-buying', key: 'footer.links.sellGold' },
  ],
  help: [
    { label: 'Shipping', path: '/shipping', key: 'footer.links.shipping' },
    { label: 'Returns', path: '/returns', key: 'footer.links.returns' },
    { label: 'FAQ', path: '/faq', key: 'footer.links.faq' },
    { label: 'Track Order', path: '/track-order', key: 'footer.links.trackOrder' },
    { label: 'Privacy Policy', path: '/privacy', key: 'footer.links.privacy' },
    { label: 'Terms', path: '/terms', key: 'footer.links.terms' },
  ],
};
