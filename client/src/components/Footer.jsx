      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-20">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <p className="text-sm font-semibold text-charcoal mb-1">{brand.legalName}</p>
          ...
          {[
            ...
            <div key={titleKey}>
              <h4 className="text-xs font-semibold tracking-wide uppercase text-charcoal mb-1">{t(titleKey)}</h4>
          ...
          <div className="col-span-2 md:col-span-1">
            <h4 className="text-xs font-semibold tracking-wide uppercase text-charcoal mb-1">Newsletter</h4>
            <div className="section-title-line mb-4" />
            ...
            <form onSubmit={handleNewsletter} className="flex border border-border bg-white rounded-md overflow-hidden">
              <input
                ...
                className="flex-1 px-3 py-2.5 text-sm bg-transparent focus:outline-none text-charcoal placeholder:text-[#999999]"
                required
              />
