...
async function seedRunner() {
  ...
  await Blog.insertMany([
    { title: 'Gold Chain Manufacturing Standards', slug: 'gold-chain-manufacturing-standards', excerpt: 'Professional gold chain production for international buyers.', content: 'Modern Gold manufactures gold chains in 14K, 18K and 22K at our Namangan facility. International jewellers and gold traders rely on consistent quality, weight accuracy and export-ready finishing.', category: 'Manufacturing', author: 'Modern Gold', image: getCategoryImage('chains') },
    { title: 'Choosing Gold Purity for Wholesale', slug: 'choosing-gold-purity-wholesale', excerpt: '14K, 18K and 22K — which purity suits your market?', content: 'Different markets prefer different gold purities. Modern Gold produces chains and bangles in 14K, 18K and 22K to serve international wholesale partners across Central Asia and beyond.', category: 'Buying Guide', author: 'Modern Gold', image: getCategoryImage('bangles') },
    { title: 'International Gold Trade from Central Asia', slug: 'international-gold-trade-central-asia', excerpt: 'Connecting regional gold supply with global markets.', content: 'Modern Gold operates at the intersection of local gold sourcing and international jewellery manufacturing. Local sellers bring gold to us; international buyers source finished chains and bangles from our Namangan facility.', category: 'Industry', author: 'Modern Gold', image: getCategoryImage('chains') },
  ]);
