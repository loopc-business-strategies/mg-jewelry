...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'MANAGER', 'SALES_EXECUTIVE', 'CUSTOMER');

-- CreateEnum
CREATE TYPE "Locale" AS ENUM ('en', 'uz', 'ru', 'tr');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_PAYMENT', 'PAID', 'AWAITING_PICKUP', 'PENDING_SHIPPING_QUOTE', 'PROCESSING', 'SHIPPED', 'COMPLETED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('STRIPE', 'PAYME', 'CLICK', 'SHOWROOM');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'SUCCEEDED', 'FAILED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "FulfillmentType" AS ENUM ('SHOWROOM_PICKUP', 'LOCAL_DELIVERY', 'INTERNATIONAL_QUOTE');
...
CREATE TABLE "Product" (
    ...
    "makingChargePct" DECIMAL(5,2) NOT NULL DEFAULT 0,
    ...
    "shipsInternational" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "Order" (
    ...
    "fulfillmentType" "FulfillmentType" NOT NULL DEFAULT 'SHOWROOM_PICKUP',
