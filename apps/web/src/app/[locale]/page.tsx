...
export default async function HomePage({
  ...
  const newest = (products.filter((p) => p.isNewArrival).length
  ...
  return (
    <>
      ...
      <section className="relative min-h-[100svh] overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-end px-5 pb-20 pt-40 md:px-8 md:pb-28">
          <HeroMotion>
      ...
      <TrustStrip />
      <CollectionMarquee collections={collections} locale={locale} />
      ...
      <Reveal>
        <section className="mx-auto max-w-7xl px-5 py-10 md:px-8">
          ...
          <ProductRail products={bestsellers} locale={locale} />
        </section>
      </Reveal>
      ...
      <Reveal>
        <section className="mx-auto max-w-7xl px-5 py-16 md:px-8">
          ...
          <ProductRail products={newest} locale={locale} />
        </section>
      </Reveal>
